...
class FluentuLeadbox
{
    ...
    {
        if (is_single()) {
            wp_enqueue_style('fluentu-leadbox', plugin_dir_url(__FILE__) . 'css/style.css', [], '2.7.2');
            wp_enqueue_script('fluentu-leadbox', plugin_dir_url(__FILE__) . 'js/scripts.js', [], '2.7.2', true);
